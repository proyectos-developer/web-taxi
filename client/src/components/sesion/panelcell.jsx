    ...
    return (
        <div className='justify-content-center d-flex' style={{width: '100%', paddingTop: 100 / proporcional, paddingBottom: 100 / proporcional}}>
            <div className='shadow rounded' style={{width: '80%', padding: 20 / proporcional}}>
                ...
                <div className='rounded' style={{width: 360 / proporcional, border: !ecorreo ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                ...
                <div className='d-flex rounded' style={{width: 360 / proporcional, border: !epassword ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                    ...
                    <div className='d-flex' style={{width: 360 / proporcional, height: 40 / proporcional, marginBottom: 10 / proporcional}}>
                        <div className='d-flex' style={{width: 180 / proporcional, height: 40 / proporcional}}
                        ...
                        <div className='d-flex justify-content-end' style={{width: 180 / proporcional, height: 40 / proporcional}}
                ...
                <div className='d-flex justify-content-start' style={{width: 320 / proporcional, marginBottom: 10 / proporcional}}>
                    <p style={{fontSize: 16 / proporcional, lineHeight: `${18 / proporcional}px`, marginBottom: 0 / proporcional, color: '#212121',
                                textAlign: '', fontWeight: 700, marginRight: 5 / proporcional, cursor: 'pointer'}} onClick={() => recuperar_password()}>
                ...
                <button className='btn rounded-pill' style={{width: boton_sesion ? 318 / proporcional : 320 / proporcional, 
