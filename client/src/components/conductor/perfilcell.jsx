...
export default function  PerfilConductorCell({proporcional}) {
            ...
            <div className='' style={{width: 459 / proporcional}}>
                ...
                <div className='rounded' style={{width: 459 / proporcional, border: !ecorreo ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                ...
                </div>
                    {
                        editar ? (
                            <div className='' style={{width: 459 / proporcional}}>
                                <button className='btn rounded-pill' style={{width: boton_cancelar ? 455 / proporcional : 457 / proporcional, 
                                ...
                                <button className='btn rounded-pill' style={{width: boton_actualizar ? 455 / proporcional : 457 / proporcional, 
                            ...
                            <div className='d-flex justify-content-end' style={{width: 459 / proporcional, height: 50 / proporcional}}>
                                <button className='btn rounded-pill' style={{width: boton_editar ? 455 / proporcional : 457 / proporcional, 
                                    fontSize: 24 / proporcional, height: 50 / proporcional,
