...
export default function PanelConductor({proporcional}) {

    return (
        <div style={{width: '100%'}}>
            <div style={{width: '100%'}} className='d-flex'>
                <div style={{width: '50%', background: 'rgba(231, 229, 225, 0.6'}} className='position-relative'>
                    <div className='position-absolute translate-middle' style={{width: 'auto', height: 'auto', top: '50%', left: 500 / proporcional, right: 50}}>
                        ...
                        <div className='d-flex'>
                            <div style={{width: '50%', marginRight: 20 / proporcional}}>
                                <img src={google_play} style={{width: 197 / proporcional, height: 59 / proporcional}}/>
                            </div>
                            <div style={{width: '50%'}}>
                                <img src={app_store}  style={{width: 180 / proporcional, height: 59 / proporcional}}/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div style={{width: '100%', paddingLeft: 240 / proporcional, paddingRight: 240 / proporcional, paddingTop: 100 / proporcional, 
                         paddingBottom: 100 / proporcional}} className=''>
            ...
            <div style={{width: '100%', paddingLeft: 240 / proporcional, paddingRight: 240 / proporcional, paddingTop: 100 / proporcional, 
                         paddingBottom: 100 / proporcional, background: 'rgba(231, 229, 225, 0.6)'}} className=''>
                <p style={{fontSize: 30 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 20 / proporcional, color: '#000000', fontWeight: 700,
                        textAlign: 'center'}}>
