...
export default function VehiculoConductorCell({proporcional}) {
    ...
    return (
        <div className='' style={{width: '100%', paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional, 
            ...
            <div style={{width: 459 / proporcional}}>
                ...
                {
                  input_marca ? (
                    <div className='rounded' style={{width: 459 / proporcional, border: !emarca_carro ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                        ...
                        <input type='text'
                            ...
                            style={{width: 457 / proporcional, height: 50 / proporcional, 
                ...
                {
                  input_modelo ? ( 
                    <div className='rounded' style={{width: 459 / proporcional, border: !emodelo_carro ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                                marginBottom: 20 / proporcional}}>
                        <input type='text'
                            disabled={!editar}
                            className='form-control border-0'
                ...
                <div className='rounded' style={{width: 459 / proporcional, border: !efecha_expedicion ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                            marginBottom: 20 / proporcional}}>
                    <input type='date'
                        disabled={!editar}
                        className='form-control border-0'
                ...
                <div className='rounded' style={{width: 459 / proporcional, border: !efecha_revalidacion ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                            marginBottom: 20 / proporcional}}>
                    <input type='date'
                        disabled={!editar}
                        className='form-control border-0'
                ...
                <div className='rounded' style={{width: 459 / proporcional, border: !ecategoria ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                            marginBottom: 20 / proporcional}}>
                    <input type='text'
                        disabled={!editar}
                        className='form-control border-0'
                ...
                <div className='rounded' style={{width: 459 / proporcional, border: !eclase ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red',
                            marginBottom: 20 / proporcional}}>
                    <input type='text'
                        disabled={!editar}
                        className='form-control border-0'
                ...
                <div className='rounded' style={{width: 459 / proporcional, border: !elicencia_conducir ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                            marginBottom: 20 / proporcional}}>
                    <input type='text'
                        disabled={!editar}
                        className='form-control border-0'
                ...
                <div className='rounded' style={{width: 459 / proporcional, border: !enro_placa ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red',
                            marginBottom: 20 / proporcional}}>
                    <input type='text'
                        disabled={!editar}
                        className='form-control border-0'
                ...
                <div className='rounded' style={{width: 459 / proporcional, border: '1px solid rgba(158,158,158, 0.6)',
                ...
                </div>
                {
                    editar ? (
                        <div className='' style={{width: 459 / proporcional}}>
                            <button className='btn rounded-pill' style={{width: boton_cancelar ? 457 / proporcional : 459 / proporcional, 
                                fontSize: 24 / proporcional, height: 50 / proporcional, marginBottom: 20 / proporcional,
                                background: '#212121', color: 'white', fontWeight: boton_cancelar ? 600 : 700}}
                                onMouseOver={() => setBotonCancelar(true)} onMouseLeave={() => setBotonCancelar(false)}
                                onClick={() => {setEditar(false); setInputMarca(false); setInputModelo(false)}}>
                                Cancelar edición
                            </button>
                            <button className='btn rounded-pill' style={{width: boton_actualizar ? 457 / proporcional : 459 / proporcional, 
                                fontSize: 24 / proporcional, height: 50 / proporcional,
                                background: '#212121', color: 'white', fontWeight: boton_actualizar ? 600 : 700}}
                        ...
                        <div className='d-flex justify-content-end' style={{width: 459 / proporcional, height: 50 / proporcional}}>
                            <button className='btn rounded-pill' style={{width: boton_editar ? 457 / proporcional : 459 / proporcional, 
                                fontSize: 24 / proporcional, height: 50 / proporcional,
