...
export default function DashboardConductor({proporcional}) {
    ...
    return ( 
        <div className='' style={{width: '100%', paddingTop: 150 / proporcional, paddingBottom: 150 / proporcional, 
                paddingLeft: 240 / proporcional, paddingRight: 240 / proporcional}}>
            <div className='' style={{width: 1440 / proporcional, top: 50}}>
            ...
            <div className='d-flex ' style={{width: 1440 / proporcional}}>
