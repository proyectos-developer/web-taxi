...
export default function PerfilPasajeroCell({proporcional}) {
        ...
        <div className='' style={{width: '100%', paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional, 
            ...
            <div className='' style={{width: 459 / proporcional}}>
                <div style={{width: 459 / proporcional}}>
                    ...
                    <div className='rounded' style={{width: 459 / proporcional, border: !enombres ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                    ...
                    <div style={{width: 459 / proporcional, height: 73 / proporcional, marginBottom: 20 / proporcional}}>
                        <p style={{fontSize: 16 / proporcional, lineHeight: `${18 / proporcional}px`, color: '#212121',
                                    textAlign: '', fontWeight: 700, marginBottom: 5 / proporcional}}>
                            Tipo documento
                        </p>
                        <div className='rounded' style={{width: 459 / proporcional, border: !etipo_documento ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                                    marginBottom: 20 / proporcional}}>
                            <select type='text'
                                disabled={!editar}
                                className='form-control border-0'
                    ...
                    <div style={{width: 459 / proporcional, height: 73 / proporcional, marginBottom: 20 / proporcional}}>
                        ...
                        <div className='rounded' style={{width: 459 / proporcional, border: !enro_documento ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                                    marginBottom: 20 / proporcional}}>
                            <input type='number'
                                disabled={!editar}
                                className='form-control border-0'
                    ...
                    <div style={{width: 459 / proporcional, height: 73 / proporcional, marginBottom: 20 / proporcional}}>
                        ...
                        <div className='rounded' style={{width: 459 / proporcional, border: !efecha_nacimiento ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                                    marginBottom: 20 / proporcional}}>
                            <input type='date'
                                disabled={!editar}
                                className='form-control border-0'
                    ...
                    <div style={{width: 459 / proporcional, height: 73 / proporcional, marginBottom: 20 / proporcional}}>
                        ...
                        <div className='rounded' style={{width: 459 / proporcional, border: !enro_telefono ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                                    marginBottom: 20 / proporcional}}>
                            <input type='number'
                                disabled={!editar}
                                className='form-control border-0'
                    ...
                    <div className='rounded' style={{width: 459 / proporcional, border: !ecorreo ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                                marginBottom: 20 / proporcional}}>
                        <input type='email'
                            disabled={!editar}
                            className='form-control border-0'
                    ...
                    {
                        editar ? (
                            <div className='' style={{width: 459 / proporcional, height: 120 / proporcional}}>
