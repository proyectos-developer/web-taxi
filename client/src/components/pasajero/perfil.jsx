...
export default function PerfilPasajero({proporcional}) {
    ...
    return (
        <div className='' style={{width: '100%', paddingTop: 100 / proporcional, paddingBottom: 100 / proporcional, 
            ...
            <div className='d-flex justify-content-center' style={{width: 1440 / proporcional}}>
                <div style={{width: 700 / proporcional}}>
                    ...
                    <div className='rounded' style={{width: 700 / proporcional, border: !enombres ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                    ...
                    <div className='rounded' style={{width: 700 / proporcional, border: '1px solid rgba(158,158,158, 0.6)', 
                                marginBottom: 20 / proporcional}}>
                        <input type='text'
                            disabled={!editar}
                            className='form-control border-0'
