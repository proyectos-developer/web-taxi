...
export default function RegistroPanelTablet({proporcional}) {
        ...
        <div className='justify-content-center d-flex' style={{width: '100%', paddingTop: 100 / proporcional, paddingBottom: 100 / proporcional}}>
            <div className='shadow rounded' style={{width: '80%', padding: 20 / proporcional}}>
                ...
                <div style={{paddingLeft: 100 / proporcional, paddingRight: 100 / proporcional}}>
                    ...
                    <div className='rounded' style={{width: 540 / proporcional, border: !enombres ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                    ...
                    <div className='rounded' style={{width: 540 / proporcional, border: !enro_telefono ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                                marginBottom: 20 / proporcional}}>
                        <input type='number'
                            className='form-control border-0'
                            value={nro_telefono}
                    ...
                    <div className='d-flex rounded' style={{width: 540 / proporcional, border: !econfirmar_password ? '1px solid rgba(158,158,158, 0.6)' : '1px solid red', 
                                marginBottom: 20 / proporcional}}>
                    ...
                    <button className='btn rounded-pill' style={{width: boton_registro ? 538 / proporcional : 540 / proporcional, 
