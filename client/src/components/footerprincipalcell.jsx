...
export default function FooterPrincipalTablet({proporcional}) {
    ...
    return (
        <div className='' 
            ...
            <div style={{width: '100%', paddingTop: 35 / proporcional, paddingBottom: 35 / proporcional}}>
                <p style={{fontSize: 24 / proporcional, lineHeight: `${30 / proporcional}px`, color: 'white', fontWeight: 500, cursor: 'pointer', marginBottom: 10 / proporcional}}
            ...
            <div style={{width: '100%', paddingTop: 26 / proporcional, paddingBottom: 26 / proporcional}}>
                <p style={{fontSize: 24 / proporcional, lineHeight: `${30 / proporcional}px`, color: 'white', fontWeight: 500, cursor: 'pointer', marginBottom: 10 / proporcional,
                    textAlign: 'center'}}>
                    Encuentranos en:
                </p>
