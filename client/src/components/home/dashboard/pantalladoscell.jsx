...
export default function CardPantallaDosCell({proporcional}) {
    return (
        <div id='carouselPantalla1' className='carousel slide' data-bs-ride="carousel" style={{width: '60%', padding: 5 / proporcional}}>
