...
export default function SesionHomeCell({proporcional}) {

    const navigate = useNavigate()

    return (
        <div className='' 
            style={{width: 459 / proporcional, marginLeft: 20 / proporcional, marginRight: 60 / proporcional, borderRadius: 64 / proporcional, 
                    border: '20px solid rgba(39, 39, 39, 0.8)'}}>
            <div style={{background: 'rgba(39, 39, 39, 0.8)', borderRadius: 32 / proporcional}}>
                <div className='position-relative'>
                    <img src={fondo_home_3} style={{width: 419 / proporcional, borderRadius: 32 / proporcional, marginBottom: 20 / proporcional}}/>
                    <div className='position-absolute' style={{left: 20 / proporcional, top: 20 / proporcional, opacity: 0.8}}>
                        <img src={logo} style={{width: 64 / proporcional, height: 64 / proporcional}}/>
                    </div>
                </div>
                <div className='' style={{width: 419 / proporcional, borderRadius: 32 / proporcional}}>
                    <div style={{width: 419 / proporcional, background: 'rgba(39, 39, 39, 0.8)', padding: 20 / proporcional, marginBottom: 20 / proporcional,
                    ...
                    <div style={{width: 419 / proporcional, background: 'rgba(39, 39, 39, 0.8)', padding: 20 / proporcional, 
                                borderRadius: 32 / proporcional}}>
                        <div className='d-flex justify-content-center' style={{marginBottom: 10 / proporcional}}>
