...
export default function CardPantallaUnoTablet({proporcional}) {
    return (
        <div id='carouselPantalla0' className='carousel slide' data-bs-ride="carousel" style={{width: '33%', padding: 20 / proporcional}}>
