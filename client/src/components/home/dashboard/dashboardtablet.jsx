...
import fondo_home_tablet from '../../../assets/images/fondo_home_tablet.png'
...
export default function DasboardHomeTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%'}}>
            <img src={fondo_home_tablet} style={{width: '100%'}}/>
            <div className='' style={{width: '100%', background: 'black', padding: 120 / proporcional}}>
            ...
            <div className='d-flex' style={{width: '100%', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
                <div id='carouselPantalla0' className='carousel slide' data-bs-ride="carousel" style={{width: '33%', padding: 30 / proporcional}}>
                ...
                <div id='carouselPantalla1' className='carousel slide' data-bs-ride="carousel" style={{width: '33%', padding: 10 / proporcional}}>
                    <div className='carousel-inner'>
                        <div className='carousel-item active' style={{width: '100%'}} data-bs-interval="3000">
                            <img src={pantalla_1} style={{width: '100%'}}/>
                        </div>
                ...
                <div id='carouselPantalla2' className='carousel slide' data-bs-ride="carousel" style={{width: '33%', padding: 30 / proporcional}}>
                    <div className='carousel-inner'>
                        <div className='carousel-item active' style={{width: '100%'}} data-bs-interval="3000">
                            <img src={pantalla_2} style={{width: '100%'}}/>
                        </div>
