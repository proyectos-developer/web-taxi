...
export default function CardPantallaTresTablet({proporcional}) {
    return (
        <div id='carouselPantalla2' className='carousel slide' data-bs-ride="carousel" style={{width: '33%', padding: 20 / proporcional}}>
