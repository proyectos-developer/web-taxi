...
export default function CardPantallaDosTablet({proporcional}) {
    return (
        <div id='carouselPantalla1' className='carousel slide' data-bs-ride="carousel" style={{width: '33%', padding: 5 / proporcional}}>
