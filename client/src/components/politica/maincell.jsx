...
export default function PoliticaPrivacidad({proporcional}) {
    return (
        <div className='' style={{width: 499 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, height: 'auto',
                paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional, background: 'rgb(139, 139, 137, 0.2)'}}>
            <p style={{width: 459 / proporcional, textAlign: 'justify', fontSize: 34 / proporcional, marginBottom: 0 / proporcional, lineHeight: `${45 / proporcional}px`, color: '#374294', 
                    fontFamily: 'Russo One, sans-serif', fontWeight: 400}}>
                Términos y Condiciones
            </p>
            
            <p style={{width: 459 / proporcional, textAlign: 'justify', fontSize: 24 / proporcional, marginBottom: 0 / proporcional, lineHeight: `${30 / proporcional}px`, color: '#374294', 
                    fontFamily: 'Russo One, sans-serif', fontWeight: 400}}>
                1. Relación contractual
            </p>
            <p style={{width: 459 / proporcional, textAlign: 'justify', fontSize: 20 / proporcional, lineHeight: `${22 / proporcional}px`, color: '#212121', fontWeight: 400, 
            ...
            <p style={{width: 459 / proporcional, textAlign: 'justify', fontSize: 20 / proporcional, lineHeight: `${22 / proporcional}px`, color: '#212121', fontWeight: 600, 
                    fontFamily: 'DM Serif Display, serif'}}>
                Licencia.
            </p>
            <p style={{width: 459 / proporcional, textAlign: 'justify', fontSize: 20 / proporcional, lineHeight: `${22 / proporcional}px`, color: '#212121', fontWeight: 400, 
