...
export default function PoliticaPrivacidad({proporcional}) {
    return (
        <div className='' style={{width: 1920 / proporcional, paddingLeft: 50 / proporcional, paddingRight: 50 / proporcional, height: 'auto',
                paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional, background: 'rgb(139, 139, 137, 0.2)'}}>
            <p style={{width: 1820 / proporcional, textAlign: 'justify', fontSize: 34 / proporcional, marginBottom: 0 / proporcional, lineHeight: `${45 / proporcional}px`, color: '#374294', 
