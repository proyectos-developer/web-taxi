...
export default function BarraMenu({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 75 / proporcional, background: color ? 'black' : 'white', paddingLeft: 60 / proporcional, 
                   paddingRight: 60 / proporcional, paddingTop: 12.5 / proporcional, paddingBottom: 12.5 / proporcional}}>
              ...
              <div className='d-flex justify-content-end'>
                {
                  user_authenticated  && user_authenticated === true ? (
                    <div className='d-flex justify-content-end'>
                      <p className='rounded-pill' style={{width: 150 / proporcional, textAlign: 'center', fontSize: 20 / proporcional, lineHeight: `${40 / proporcional}px`, color: color ? 'black' : 'white',
                        marginBottom: 0,  fontWeight: menu === 'pasajero' ? 700 : 500, background: color ? 'white' : 'black', paddingLeft: 10 / proporcional, paddingRight: 10 / proporcional,
