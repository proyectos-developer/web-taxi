...
export default function RecuperarContraseñaCell({proporcional}) {
    ...
    return (
        <div className='justify-content-center d-flex' style={{width: '100%', paddingTop: 100 / proporcional, paddingBottom: 100 / proporcional}}>
            <div className='shadow rounded' style={{width: '80%', padding: 20 / proporcional}}>
                ...
                <p style={{fontSize: 16 / proporcional, lineHeight: `${22 / proporcional}px`, color: '#212121',
                ...
                <button className='btn rounded-pill' style={{width: boton_enviar ? 358 / proporcional : 360 / proporcional, 
